          ...
          {playerOrder.map((player, index) => (
            ...
            >
              ...
              <div className="gameboard-lines-player-copy">
                <div className="gameboard-lines-name">{player.name}</div>
                <div className={`gameboard-lines-marker marker-${markerToneClassByIndex[index] || 'tone-a'}`}>
                  {player.marker}
                </div>
              </div>
          ...
          <>
            <div className="gameboard-lite-header">
              <div className={`gameboard-lite-player ${currentPlayer === 'X' && !gameOver ? 'active' : ''}`}>
                ...
                <div>
                  <div className="gameboard-lite-name">{players.X.name}</div>
                  <div className="gameboard-lite-subtitle">{players.X.marker}</div>
                </div>
              </div>
              ...
              <div className={`gameboard-lite-player ${currentPlayer === 'O' && !gameOver ? 'active' : ''}`}>
                ...
                <div>
                  <div className="gameboard-lite-name">{players.O.name}</div>
                  <div className="gameboard-lite-subtitle">{players.O.marker}</div>
                </div>
              </div>
            </div>
