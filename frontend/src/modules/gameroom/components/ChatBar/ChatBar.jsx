                ...
                <div ref={historyRef} className="chat-history-list">
                    {messages.length ? (
                        messages.map((item) => (
                            <div
                                key={item.id}
                                className={`chat-message-row ${item.isOwn ? 'chat-message-row-own' : 'chat-message-row-other'}`}
                            >
                            <div className={`chat-message-item ${item.isOwn ? 'chat-message-own' : 'chat-message-other'}`}>
