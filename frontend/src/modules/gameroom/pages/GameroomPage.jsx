...
function GameroomPage() {
  ...
  const handleSize = () => {
    if (roomSize === 4) {
      return <FourPeople players={players} onAddAI={handleAddAI} onRemoveAI={handleRemoveAI} canManageAI={isCurrentUserHost} />;
    }
     

    if (roomSize === 3) {
      return <ThreePeople players={players} onAddAI={handleAddAI} onRemoveAI={handleRemoveAI} canManageAI={isCurrentUserHost} />
    }
    

    if (roomSize === 2) {
      return <TwoPeople players={players} onAddAI={handleAddAI} onRemoveAI={handleRemoveAI} canManageAI={isCurrentUserHost} />
    }
