    ...
    <div className="neon-page min-h-screen px-4 py-8">
      <div className="neon-shell mx-auto max-w-6xl">
        ...
        <div className="neon-card neon-card-strong overflow-hidden rounded-[32px]">
          <div className="border-b border-white/8 bg-gradient-to-r from-white/6 via-blue-400/6 to-purple-400/8 px-6 py-8 sm:px-8">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.22em] text-cyan-200">
            ...
            {isLoading ? (
              ...
              <div className="grid gap-4">
                {matches.map((match) => (
                  <div
                    key={match.gameId}
                    className="rounded-[28px] border border-white/8 bg-slate-950/40 p-5 transition hover:border-blue-400/20 hover:bg-slate-950/55"
                  >
                          ...
                          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                            {getMatchParticipants(match).map((participant, index) => (
                              <div
                                ...
                                className="flex min-w-0 items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.04] px-3 py-3"
                              >
                                <img
